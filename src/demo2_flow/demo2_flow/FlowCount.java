...
class FlowCount {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.setInputPaths(job, new Path("C:/work/java/first/src/demo2_flow/flow.dat"));
		FileOutputFormat.setOutputPath(job, new Path("C:/work/java/first/src/demo2_flow/output"));
